...
interface marketPlace{
    ...
    function buyOrderStats(uint256 order) external view returns(address buyer, address BOcontract, uint256 BOid, uint256 BOprice, bool BOprogress);
    
    function sellOrderStats(uint256 order) external view returns(address seller, address SOcontract, uint256 SOid, uint256 SOprice, bool SOprogress);
    
    function buy(uint256 sellOrder) external;
    
    function sell(uint256 buyOrder) external;
    
    function createBuyOrder(address BOcontract, uint256 BOid, uint256 BOprice) external;
    ...
    function rentOfferStats(uint256 offer) external view returns(address lord, address ROcontract, uint256 ROid, uint256 ROprice, uint256 ROperiod, address ROtaker, uint256 ROblock, bool ROprogress);
    
    function createRentOffer(address ROcontract, uint256 ROid, uint256 ROprice, uint256 ROperiod) external;
    ...
    function loanRequestStats(uint256 offer) external view returns(address borrower, address LOcontract, uint256 LOid, uint256 LOamount, uint256 LOprepayment, uint256 LOperiod, address LOinvestor, uint256 LOblock, bool LOprogress, bool LOrepayed);
    
    function askForLoan(address LOcontract, uint256 LOid, uint256 LOamount, uint256 LOprepayment, uint256 LOperiod) external;
...
//==============================================================================================================================================================================================================    
    function buyOrderStats(uint256 order) external view override returns(address buyer, address BOcontract, uint256 BOid, uint256 BOprice, bool BOprogress){
        buyer = _buyer[order];
    ...
    function sellOrderStats(uint256 order) external view override returns(address seller, address SOcontract, uint256 SOid, uint256 SOprice, bool SOprogress){
    ...
    function createBuyOrder(address BOcontract, uint256 BOid, uint256 BOprice) external override {
...
//==============================================================================================================================================================================================================  
    ...
    function loanRequestStats(uint256 offer) external view override returns(address borrower, address LOcontract, uint256 LOid, uint256 LOamount, uint256 LOprepayment, uint256 LOperiod, address LOinvestor, uint256 LOblock, bool LOprogress, bool LOrepayed){
